...
export default function PageBase({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center font-sans pt-2 sm:pt-10">
      {showThemeToggle && <ModeToggle />}
      <main className="flex w-full max-w-4xl flex-col py-12 sm:py-24 px-8 sm:flex-1">
